(function(global, evalGlobal) {
    ...
    */
    ...
    var prefix = new Myna.File("/WEB-INF/narwhal/").javaFile.toString();
    ...
    var isFile = function (path) {
        try { return new java.io.File(path).isFile(); } catch (e) {
           /*try{ 
              return new java.io.File(path.replace(/\//g,"\\").replace(/\\\\/g,"\\")).isFile();
           } catch(e){} */
        }
        return false;
    };
    ...
    narwhal({
        ...
        platform: 'myna',
        platforms: ['myna', 'rhino', 'default'],
        print: print,
        fs: {
            read: read,
            isFile: isFile,
            SEPARATOR:String(Packages.java.lang.System.getProperty("file.separator"))
        },
        prefix: prefix,
